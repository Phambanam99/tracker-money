...
import com.devhunter9x.firstapp.routing.personalRoutes
...
fun Application.module() {
    ...
    routing {
        // Health check
        get("/") { call.respond(mapOf("status" to "ok", "message" to "Expense Tracker API")) }
        ...
        personalRoutes() // /personal/expenses
    }
}
